...
ShuffleNetV1 showed that group convs and channel shuffle could reduce FLOPs, but in practice:
...
\begin{itemize}[leftmargin=2em]
	...
	\item \textbf{NAS-guided design} in MobileNetV3, despite introducing seemingly fragmented connections (counter to G3), includes operator fusions and expansions that improve efficiency in practice.
