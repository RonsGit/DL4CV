...
\begin{enrichment}[Regularization in the Era of Finetuning][subsection]
	...
	\begin{itemize}
		\item \textbf{For shallow heads (1–2 layers):} Dropout is rarely used unless the dataset is very small or prone to label noise. Lighter \(\ell_2\) weight decay is typically preferred.
