...
\section{Interpreting Neural Networks}
...
\section{Building Deep Neural Networks}
Deep neural networks are formed by stacking multiple layers. The \emph{depth} of a network refers to the number of these layers, while the \emph{width} describes the number of neurons (hidden units) per layer.
...
\section{A Simple Neural Network in 20 Lines}
