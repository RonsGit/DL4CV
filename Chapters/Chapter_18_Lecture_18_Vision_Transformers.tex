...
\begin{itemize}
    \item \textbf{Self-Attention Generative Adversarial Networks (SAGAN)} \cite{zhang2019_sagan}, which used self-attention in GANs to improve the quality of generated images.
