...
\begin{itemize}
    ...
    \item \textbf{Photometric assumptions.} Most SfM–MVS methods assume Lambertian surfaces and brightness constancy. Real-world effects such as specularities, translucency, and variable illumination violate these assumptions, corrupting correspondence and depth estimates~.
...
\begin{enrichment}[Mip-NeRF: Anti-Aliased Radiance Fields][subsection]
    ...
    \begin{equation}
        ...
        \Big).
        \label{eq:chapter23_mipnerf_objective}
    \end{equation}
    ...
    \begin{equation}
        ...
        \label{eq:chapter23_mipnerf_blurpool_pdf}
    \end{equation}
    ...
    \begin{enrichment}[3D Gaussian Splatting: RT Radiance Field Rendering][subsection]
        ...
        \begin{itemize}
            \item \textbf{Dynamics and tracking.} Extending splats to time (4D) enables real-time dynamic rendering~\cite{wu2024_4dgs}, while dense SLAM systems fuse mapping and tracking directly with Gaussians for online reconstruction~\cite{Rosinol_2024_SplaTAM}.
...
\begin{enrichment}[NeRF: Generative \& Cross-Modal Foundations][section]
    ...
    \begin{itemize}
        ...
        \item \textbf{Latent-NeRF / DreamFields}~\cite{metzer2022_latentnerf,jain2022_dreamfields}: Trains radiance fields in latent spaces or with strong 2D guidance to boost fidelity and efficiency.
    \end{itemize}
