...
\subsection{Swish: A Self-Gated Activation Function}
\label{sec:chapter9_swish}
...
\begin{itemize}
	...
	\item \textbf{Consider Leaky ReLU, ELU, SELU, GELU or Swish when seeking marginal gains:} These activations can help squeeze out small improvements, particularly in deeper networks or specific architectures.
