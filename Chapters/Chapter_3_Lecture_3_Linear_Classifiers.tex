...
\begin{enrichment}[Why Cross-Entropy Uses Logarithms, Not Squared Errors][subsubsection]
	...
	\noindent
	Cross-entropy loss is the standard choice for classification, especially when used with the softmax output layer. But why does it use logarithms, and not something seemingly simpler like squared error?
