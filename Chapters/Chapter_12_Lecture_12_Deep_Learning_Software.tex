...
\subsection{PyTorch: Fundamental Concepts}
...
\subsection{Dynamic vs. Static Computational Graphs in PyTorch}
...
\subsubsection{Static Graphs and Just-in-Time (JIT) Compilation}
...
\subsubsection{Using JIT to Create Static Graphs}
...
\subsubsection{Handling Conditionals in Static Graphs}
...
\subsubsection{Optimizing Computation Graphs with JIT}
...
\subsubsection{Benefits and Limitations of Static Graphs}
...
\subsubsection{When Are Dynamic Graphs Necessary?}
...
\subsection{TensorFlow: Dynamic and Static Computational Graphs}
...
\subsubsection{Defining Computational Graphs in TensorFlow 2.0}
...
\subsubsection{Static Graphs with \texttt{tf.function}}
...
\subsection{Keras: High-Level API for TensorFlow}
\label{subsec:chapter12_keras}

Keras provides a high-level API for building deep learning models, simplifying model definition and training.
...
\begin{itemize}
	...
	\item \textbf{Common loss functions and optimizers}: Use built-in losses and optimizers like Adam, SGD, etc.
	\item \textbf{Automatic gradient handling}: The \texttt{opt.apply\_gradients()} method simplifies parameter updates.
\end{itemize}
...
\subsection{TensorBoard: Visualizing Training Metrics}
...
\subsection{Comparison: PyTorch vs. TensorFlow}
