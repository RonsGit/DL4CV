...
\begin{enumerate}
	\item \textbf{New to the Field:} Start by watching the 
	\href{https://www.youtube.com/watch?v=dJYGatp4SvA\&list=PL5-TkQAfAZFbzxjBHtzdVCWE0Zbhomg7r\&index=1\&ab_channel=MichiganOnline}{EECS498 lectures on YouTube}. 
...
\input{Chapters/Chapter_25_Reinforcement_Learning}
\input{Chapters/Chapter_26_Model_Compression_Quantization_and_Pruning}
\input{Chapters/Chapter_27_Foundation_Models_in_Computer_Vision}
\input{Chapters/Chapter_28_MAMBA}
