...
\vspace*{0.7cm}
{\LARGE Ron Korine, 2026}\\[-0.35em] % tighten the gap to the thanks line
...
\noindent \textsc{https://github.com/RonsGit/DL4CV}\\ % URL
...
\noindent \textit{2026} % Printing/edition date
